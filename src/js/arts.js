export const funcControlArts = title => {
  ...
  if (body.classList.contains('section-night')) {
    ...
    document.querySelector('.modal-pagination').style.backgroundColor =
      '#751D1D';
    document
      .querySelectorAll('.team-list__text')
      .forEach(e => (e.style.color = '#ff6b01'));
    document
      .querySelectorAll('.team-list__item')
      .forEach(e => (e.style.background = '#251c1cf3'));
    document.querySelector('.team-container').style.backgroundColor =
      'rgba(107, 18, 18, 0.907)';
  ...
  document
    .querySelectorAll('.team-list__item')
    .forEach(e => (e.style.background = '#fff'));
